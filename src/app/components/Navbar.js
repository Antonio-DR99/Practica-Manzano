...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className={`fixed left-0 top-0 h-full ${isOpen ? 'w-60' : 'w-0'} bg-white shadow-lg flex flex-col justify-between z-40 transition-all duration-300 ease-in-out overflow-hidden`}>
      ...
      {/* Eliminamos el botón de hamburguesa para móviles ya que ahora tenemos uno universal */}
      
      {/* Ya no necesitamos el menú móvil desplegable separado */}
      </nav>
    </>
  );
}